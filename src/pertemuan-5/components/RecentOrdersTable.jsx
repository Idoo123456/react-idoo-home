...
const RecentOrdersTable = ({ onViewAll }) => {
  const orders = [
    ...
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="mt-6 text-center">
        <button 
          type="button" 
          onClick={onViewAll}
          className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-2xl shadow-md transition hover:shadow-lg hover:scale-105"
        >
          View All Orders →
        </button>
      </div>
